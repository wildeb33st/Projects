...
HD_PWD='/home/gear/FPAGA/Labs/Lab11_2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab111.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab111.tcl
